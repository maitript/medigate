...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService = createFargateService("AuthService",
                ...
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET","fc8dfebf27b377059165fd478d669c35559a3118e6902f6b2feeb5a6eda78ba9"));
    ...
    private CfnCluster createMskCluster(){
        // Get the number of subnets you are passing
        int subnetCount = vpc.getPrivateSubnets().size();

        return CfnCluster.Builder.create(this, "MskCluster")
                .clusterName("kafka-cluster")
                .kafkaVersion("3.4.0")
                .numberOfBrokerNodes(subnetCount) // Fix: Match the subnet/AZ count
